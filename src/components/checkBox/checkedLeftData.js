          ...
          <div className={styles.outerPart}>
            ...
            <div className={styles.textboxContainer}>
              <div className={styles.doubleBox}>
                <div>
                  <p className={`${styles.textbox5} ${styles.textbox5_1}`}>
                    5GB
                  </p>
                  <p className={styles.textbox5}>10GB</p>
                </div>
                <div>
                  <Image
                    src="/images/double-icon.png"
                    alt="두배 아이콘"
                    width={27}
                    height={17.13}
                    className={styles.doubleIconContainer}
                  ></Image>
                </div>
              </div>
              ...
              <div className={styles.doubleBox}>
                <div>
                  <p className={`${styles.textbox6} ${styles.textbox6_1}`}>
                    35GB
                  </p>
                  <p className={styles.textbox6}>70GB</p>
                </div>
                <div>
                  <Image
                    src="/images/double-icon.png"
...
export default CheckedLeftData;
