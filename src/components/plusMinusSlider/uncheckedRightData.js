        ...
        <div className={styles.sliderOuterBox}>
          <div className={styles.outerPart}>
            ...
            <div className={styles.textboxContainer}>
              <p className={styles.textbox5}>3만</p>
              <p className={styles.textbox6}>4만2천</p>
              <p className={styles.textbox7}>6만9천</p>
            </div>
...
export default UncheckedRightData;
